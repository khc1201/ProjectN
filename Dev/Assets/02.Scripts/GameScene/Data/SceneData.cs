...
public class SceneData : MonoBehaviour, IListener {
    ...
    public List<InitObject> initObjects;
    ...
    */
    ...
    void Start ()
    {
        ...
        /*
        initObjects = new List<InitObject>();
        InitObject[] iniobjects = FindObjectsOfType<InitObject>();
        foreach(var e in iniobjects)
        {
            initObjects.Add(e);
        }*/
	}
